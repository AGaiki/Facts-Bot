...
async def nine_nine(ctx): #Do NOT change the nine_nine definition. This project was forked and modified from another one, and it will NOT work without the nine_nine definition.
    fish_fax = [ #The 'Test', 'Test 2', 'Test 3' are correctly formatted. You can edit that text and add as much as you want. If you want to change the fish_fax value on this line, make sure to change the value of "response = random.choice(fish_fax)", changing fish_fax to whatever you would like to change it to. 
        'Test',
        'Test 2',
        'Test 3'
    ]
    response = random.choice(fish_fax)
